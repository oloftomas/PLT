...
public class STypedeft extends Stm {
  public final Type type_;
  public final String id_;
  public STypedeft(Type p1, String p2) { type_ = p1; id_ = p2; }

  public <R,A> R accept(CPP.Absyn.Stm.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof CPP.Absyn.STypedeft) {
      CPP.Absyn.STypedeft x = (CPP.Absyn.STypedeft)o;

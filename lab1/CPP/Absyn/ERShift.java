...
public class ERShift extends Exp {
  public final Exp exp_1, exp_2;
  public ERShift(Exp p1, Exp p2) { exp_1 = p1; exp_2 = p2; }

  public <R,A> R accept(CPP.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof CPP.Absyn.ERShift) {
      CPP.Absyn.ERShift x = (CPP.Absyn.ERShift)o;

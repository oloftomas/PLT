...
public class DFunemp extends Def {
  public final Type type_;
  public final String id_;
  public final ListArg listarg_;
  public DFunemp(Type p1, String p2, ListArg p3) { type_ = p1; id_ = p2; listarg_ = p3; }

  public <R,A> R accept(CPP.Absyn.Def.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof CPP.Absyn.DFunemp) {
      CPP.Absyn.DFunemp x = (CPP.Absyn.DFunemp)o;
